		...
		echo '
				<script type="text/javascript">
					function redireccionar(){
					  window.locationf="/mantenimiento.html";
					} 
			';
	}
	else{
...
<MARQUEE WIDTH=50% HEIGHT=20 align="top" bgcolor=""><b> Configuraciones Sistema Villa Conin V 3.0 </b></MARQUEE><br />Copyright - 2016 Powered By Qroodigo Consultoria
...
<li><a href='ReporteServicios.php'>Servicios</a></li></ul>
				";
echo"<li class='x'><a href='cobranza.php'>Cobranza &nbsp&nbsp&nbsp";

echo '</a></li>';
   echo"<li><a href='inventarios/index.php?usuario=".$_SESSION['usu']."'>Inventario</a></li>";
...
echo '  
   ...
   echo'
	<ul id="nav">';			
   		echo"<li  class='top'><a href='index.php' class='top_link'><span class='down'>Inicio</span></a></li>";	    
		
		  echo'
	   <li class="top"><a href="#nogo27" id="contacts" class="top_link"><span class="down">Contratos</span></a>
		<ul class="sub">
			<li><a href="#nogo28">Pre-Contrato</a>
				<ul>
					<li><b>Pre-Contrato</b></li>
					<li><a href="BuscarPreContrato.php">Ver Pre-Contrato</a></li>
					<li><a href="NuevoContrato.php">Crear PreContrato</a></li>												
				</ul>
			</li>	
			<li><a href="BuscarContrato.php">Buscar Contrato</a></li>
			<li><a href="Cargos.php">Generar Cargo</a></li>";				
			<li ><a href="Abonos-cliente.php">Abonos</span></a></li>
		</ul>
	</li>
	   ';
	  echo'
	   <li class="top"><a href="#nogo27" id="contacts" class="top_link"><span class="down">Clientes</span></a>
		<ul class="sub">
			<li><a href="#nogo28">Pre-Clientes</a>
				<ul>
					<li><b>Pre-Clientes</b></li>
					<li class="top"><a href="Preregistro.php">Nuevo Registro</a></li>
					<li class="top"><a href="BucarPreCliente.php">Ver Pre-Clientes</a></li>												
				</ul>
			</li>	
			<li><a href="#nogo28">Clientes</a>
				<ul>
					<li><b>Clientes</b></li>
					<li><a href="BuscarCliente.php">Ver Clientes</a></li>										
				</ul>
	   ...
	   ';
				  ...
				  echo'
	   <li class="top"><a href="#nogo27" id="contacts" class="top_link"><span class="down">Eventos Adicionales</span></a>
		<ul class="sub">
			<li><a href="Eventos_Adicionales.php">Nuevo Evento Adicional</a></li>	
			<li><a href="reporteEA.php">Ver Eventos Adicionales</a></li>	
		</ul>
	   ...
	   ';  		  	
	   echo"		 
			<li class='top'><a href='Recaudacion/recaudacion.php' class='top_link'><span class='top_link'>Eventos de Recaudacion</span></a></li>";		
			//////////////
					  echo'
	   <li class="top"><a href="#nogo27" id="contacts" class="top_link"><span class="down">Reportes</span></a>
		<ul class="sub">
			<li><a href="EstadoDeCuenta.php">Edo de Cuenta</a></li>
			<li><a href="BuscarContrato.php">Contrato</a></li>
			<li><a href="reporte_contratos_canceldos.php">Contratos Cancelados</a></li>
			<li><a href="reporte_finalizados.php">Contratos Finalizados</a></li>
			<li><a href="xxx.php">Eventos Adicionales</a></li>
		</ul>
	  </li>
	   ';	
	   echo"<li class='top'><a href='cerrar.php' class='top_link'><span>Cerrar sesion</span></a></li>";
   ...
   echo"</li>
     	<li>
   		...
   		<ul>
   				...
   				<li><a href='Config/AsistioMesero.php'>Confirmar Asistencia</a></li>   			
   				<li><a href='Config/ReconfirmaM.php?nivel=".$_SESSION['niv']."' >Proyeccion de Meseros</a></li>
   		</ul>
   	</li>
...
function busqueda () {
	$categoria = $_REQUEST['campo'];
		...
		$query="select * from contrato where Numero='$_REQUEST[campo]' AND estatus=1 ORDER BY Fecha ; ";
		}
		else if($_REQUEST['categoria']=="2"){
		
		$query="select * from contrato where fechacontrato='$_REQUEST[campo]' AND estatus=1 ORDER BY Fecha ;";
		}
		else if($_REQUEST['categoria']=="3"){
		
		$query="select * from contrato where estatus=1 ORDER BY Fecha;";
		}
				...
				while($muestra=mysql_fetch_array($resultado)) {
					echo "<tr>";
						...
						if($muestra['impreso']=='si'){
						 ...
						 /*echo "<td><a href='#'>Generar Hoja Anexa</a></td>";		
						echo "<td><a href='#'>Realizar Logistica</a></td>";	*/
						
						if($muestra['imphojaanexa']=='si'){
							if($_SESSION['niv']!=0 && $_SESSION['niv']!=1){
								echo '<td><b><center><a href="https://villaconin.mx/HojaAnexa.php?numero='.$muestra['Numero'].'" target="_blank">Ver Hoja Anexa </a></center></b></td>';
							}else{
								echo '<td><small><center><a href="LogisticaEvento.php?numero='.$muestra['Numero'].'" >Modificar Hoja Anexa </a></small><br>
								<a href="https://villaconin.mx/HojaAnexa.php?numero='.$muestra['Numero'].'" target="_blank">Ver Hoja Anexa </a></center></td>';	
							}
						}else{
							echo '<td><a href="LogisticaEvento.php?numero='.$muestra['Numero'].'">Modificar Hoja Anexa</a><br>';
							echo '<a href="https://villaconin.mx/HojaAnexa.php?numero='.$muestra['Numero'].'">Ver Hoja Anexa</a></td>';
						}
                    
                    $logistica=mysql_fetch_array(mysql_query("select count(*) as t from logistica where numero='".$muestra['Numero']."'"));
                    
                    if($logistica['t']>0){
                        echo '<td align="center"><a href="NuevaLogistica.php?numero='.$muestra['Numero'].'">Ver Logistica</a></td>';
                    }else{
...
echo"<br /><br /><br  style='background-position:center'/>";
	 ...
	 echo"<table border='1' align='center' title='Buscar Por' width='540px'>";
       echo"<tr>";	   
       echo"<form name='ncon' action='https://villaconin.mx/altacargo.php' method='post' >";
...
if($resultado) {			
		...
		echo "</table>";
echo"<div align='center'>";
echo"<form id='form1' name='form1' method='post' action='https://villaconin.mx/FormularioPDF/php/CargaAbono.php'>";
    ...
    echo"<table width='373' height='361' border='6' align='center' 	' border='6px' bordercolor='#990000'>";
      ...
      echo"<td>Por Concepto de</td>";
        echo"<td><label for='oncepto'></label>";
          echo"<select name='concepto' id='concepto' onchange='activar(this.value)'>";
 ...
 echo" </div>";
  echo"</form>";
	...
	$nombre=$nombre . $vi;
	//vendedor
    $first_letter=substr($v,0,1);
    $nombre=$nombre.$first_letter;
...
$query="";
		...
		if ($_REQUEST['fecha1']!='') 
		{
			$query=$query." AND fecha > '".$_REQUEST['fecha1']."' ";
		}
		if ($_REQUEST['fecha2']!='') 
		{
			$query=$query." AND fecha < '".$_REQUEST['fecha2']."' ";
		}
			...
			echo "<tbody>";			
				while($muestra=mysql_fetch_array($resultado)) {
					echo "<tr>";
						...
						///buscamos la ultima hoja anexa hecha a este cliente
						$bha=mysql_query("select * from contrato where servicios!='' and id_cliente=".$muestra["id"]." order by Fecha DESC");
						if(mysql_num_rows($bha)>0){
							$mha=mysql_fetch_array($bha);
							echo "<td><a href='HojaAnexa.php?numero=".$mha["Numero"]."' target='_blank'>Ver Hoja Anexa </a></td>";
						}else{
							echo "<td>No tiene contratos previos</td>";
						}
					echo "</tr>";
				}
			echo "</tbody>";
...
function EstadoCuenta()
{
    ...
    if(mysql_num_rows($resultado)<1){
        echo "<br><br><h2>No existe el contrato ".$campo."</h2>";
        exit();
    }
...
if($resultado) {			
				...
				$saldo_inicial=$muestra['si'];
					...
					if($muestra['facturado']=='si'){
						...
						//echo "<br>Total de Subcontratos".cantidad_subcontratos($NumeroContrato.'-');
			...
			echo "</tbody>";
		echo "</table>";
		//echo "Comensaes posicion 0: ".$comensales_cargo[0]." Total de Adultos: ".$t_adultos;
	...
	echo" <table border='2' align='center' title='Buscar Por:' width='540px' bordercolor='#0000CC'>";
       echo"<tr>";
       echo"<form action='https://villaconin.mx/busqueda.php' method='post'>";
			  ...
			  if(cantidad_subcontratos($NumeroContrato) >=2 && !isset($_POST['sub']))
			   {
				...
				{
					 echo"<td width=''  bgcolor='#FF0000' align='center'><b>".$t_cargos."<b></td>";
				}
          echo"</tr>";
           echo"<tr>";
			...
			$concepto=$muestra['concepto']."</td>";
				...
				while($muestra=mysql_fetch_array($resultado)) 
				{
					echo "<tr>";						
						...
						echo "<td style='width='600px'>".$muestra['concepto']."</td>";
						echo "<td>".$muestra['fecha']."</td>";
						//echo '<td><a href="BajaCargo.php?numero='.$muestra['id'].'&facturado='.$factura.'">Cancelar Cargo</a></td>';
						echo '<td align="center"><form action="https://villaconin.mx/BajaCargo.php" method="get" name="cancela_cargo" accept-charset="uf-8" onsubmit="return preguntar2()">
									<input type="hidden" name="numero" value="'.$muestra['id'].'">
									<input type="hidden" name="facturado" value="'.$factura.'">
									<input type="submit" name="cancelar" value="Cancelar Cargo">
							</form>';
					echo "</tr>";					
				}	
			...
			$concepto=$muestra['concepto']."</td>";
				...
				while($muestra=mysql_fetch_array($resultado)) {
					echo "<tr>";						
						...
						echo '<td align="center"><form action="https://villaconin.mx/BajaAbono.php" method="get" name="cancela_abono" accept-charset="uf-8" onsubmit="return  pregunta2()">
									<input type="hidden" name="numero" value="'.$muestra['id'].'">
									<input type="hidden" name="facturado" value="'.$factura.'">
									<input type="submit" name="cancelar" value="Cancelar Abono" >
							</form>';
					echo "</tr>";
				}			
			echo "</tbody>";
		...
		$categoria = $_REQUEST['campo'];
     	...
     	if($_REQUEST['categoria']=="0"){
    		echo ("Debe seleccionar una opci&oacute;n de la lista ");
			 ...
			 $query="select * from contrato where Fecha > '2018-01-01' AND Numero='$_REQUEST[campo]' and estatus=0 ORDER BY Fecha ;";
		}
		else if($_REQUEST['categoria']=="2"){
			 $query="select * from contrato where Fecha > '2018-01-01' AND Fecha='$_REQUEST[campo]' and estatus=0 ORDER BY Fecha ;";
		}
		else if($_REQUEST['categoria']=="3"){
			 $query="select * from contrato where Fecha > '2018-01-01' AND estatus=0 order by Fecha";
		}
		else{
			return true;
			}
...
function BUSCARPREREGISTRO(){	
		...
		if ($_REQUEST['categoria']=="todos" || $_REQUEST['categoria2']=="todos"){
			...
			echo "Debes de seleccionar una opci&oacute;n de las lista";
			return;
		}elseif ( $_REQUEST['categoria']!='0' && $_REQUEST['categoria']!='todos'){
			if ($_REQUEST['categoria']=='registro') 
			{
			 $query="SELECT * from preregistro where ".$_REQUEST['categoria']."='".$_REQUEST['vendedor1']."'";			
			}
			else
			{
			 $query="select * from preregistro where ".$_REQUEST['categoria']."='".$_REQUEST['campo1']."'";
			}
			if($_REQUEST['campo2']!="" && $_REQUEST['categoria2']!='0' && $_REQUEST['categoria2']!='todos'){
				$query=$query." and ".$_REQUEST['categoria2']."='".$_REQUEST['campo2']."'";
			}
		}if ($_REQUEST['categoria2']!='0' && $_REQUEST['categoria2']!='todos'){
			if ($_REQUEST['categoria2']=='registro') 
			{
			 $query=$query." OR ".$_REQUEST['categoria2']."='".$_REQUEST['vendedor2']."'";			
			}else{
		...
		//////ordenamiento
	$query=$query.' and nombre!="" order by nombre';
	//echo $_REQUEST['categoria']." - ".$_REQUEST['vendedor'];
		...
		echo "<table border=6 bgcolor='#fff' bordercolor='#D5C859'";
			...
			Resultados: ".mysql_num_rows($resultado)."
				...
				echo "<tr align='center'>";		
					...
					echo "<th style='width:100px;'><b>Fecha</b></th>";					
					echo "<th><b>Telefono</b></th>";	
   					echo "<th><b>Correo</b></th>";
					echo "<th><b>Medio</b></th>";
					echo "<th><b>Tipo de Evento</b></th>";
					echo "<th><b>Vendedor</b></th>";
					echo "<th><b>Comentarios</b></th>";
					if($_SESSION['niv']==0 || $_SESSION['niv']==1 || $_SESSION['niv']==4){echo "<th><b>Presupuesto</b></th>";}
			...
			echo "<tbody>";
				while($muestra=mysql_fetch_array($resultado)) {
					echo "<tr align='center'>";
						echo "<td>".$muestra['nombre']." ".$muestra['ap']." ".$muestra['am']."</td>";
						echo "<td>".$muestra['fecha']."</td>";
						...
						echo "<td>".$muestra['tipo']."</td>";
						echo "<td>".$muestra['registro']."</td>";
						echo "<td><textarea name='".$muestra['id']."' id='".$muestra['id']."' onchange='guardarComen(this.name);'>".$muestra['comentario']."</textarea></td>";
						if($_SESSION['niv']==0 || $_SESSION['niv']==1 || $_SESSION['niv']==4){
							$rp=mysql_fetch_array(mysql_query("select * from presupuesto where id_precliente=".$muestra["id"]));
							if($rp["servicios"]!=''){
								echo "<td><input type='button' name='".$muestra['id']."' value='Modificar Presupuesto' onclick='modificar_presupuesto(this.name);'>";
								echo "<input type='button' name='".$muestra['id']."' value='Ver Presupuesto' onclick='ver_presupuesto(this.name);'></td>";
							}else{
								echo "<td><input type='button' name='".$muestra['id']."' value='Relizar Presupuesto' onclick='presupuesto(this.name);'></td>";
							}
						
						}
						echo '<td><a href="Modifica-Precliente.php?numero='.$muestra['id'].'">Modificar</a></td>';
						echo '<td><a href="#" onclick="validar_presupuesto('."'".$muestra['id']."'".')">Generar nuevo Cliente</a></td>';
	...
	function inventaario(){
		...
		echo "<table   border=6 bgcolor='#fff' bordercolor='#990000'>";
			...
			$registros=0;	
			//---------------------------------------------------------------
			echo '<form action="https://villaconin.mx/update_vinos.php" method="POST">';
				while($muestra=mysql_fetch_array($resultado)) {
				...
				//-------------------------------------------------------
				echo '<form action="https://villaconin.mx/g_vinos.php" method="POST">';
				...
				//agregar nuevo
				echo '<form action="https://villaconin.mx/insert_vino.php" method="POST">';
...
function verinventario(){
		...
		echo "<table   border=6 bgcolor='#fff' bordercolor='#990000'>";
			echo "<thead>";
				...
				echo '<form action="https://villaconin.mx/insert_manteleria.php" method="POST">';
	...
	$query="select * from TManteleria where tipo='CRISTALERÍA POSTRES';";
		...
		echo "<table   border=6 bgcolor='#fff' bordercolor='#990000'>";
			echo "<thead>";
				...
				echo '<form action="https://villaconin.mx/insert_respoteria.php" method="POST">';
				echo "<input type='submit' value='Agregar nuevo' name='agregar' class='button'></form>";
				echo "<br/>";
				echo "<br/>";
	...
	$query="select * from TManteleria where tipo='CUBERTERÍA';";
		...
		echo "<table   border=6 bgcolor='#fff' bordercolor='#990000'>";
			echo "<thead>";
				...
				echo '<form action="https://villaconin.mx/insert_bodega.php" method="POST">';
				echo "<input type='submit' value='Agregar nuevo' name='agregar' class='button'></form>";
				echo "<br/>";
				echo "<br/>";
	...
	$query="select * from TManteleria where tipo='LOZA';";
		...
		echo "<table   border=6 bgcolor='#fff' bordercolor='#990000'>";
			echo "<thead>";
				...
				echo '<form action="https://villaconin.mx/insert_inloza.php" method="POST">';
				echo "<input type='submit' value='Agregar nuevo' name='agregar' class='button'></form>";
				echo "<br/>";
				echo "<br/>";
	...
	$query="select * from TManteleria where tipo='COCINA';";
		...
		echo "<table   border=6 bgcolor='#fff' bordercolor='#990000'>";
			echo "<thead>";
				...
				echo '<form action="https://villaconin.mx/insert_cocina.php" method="POST">';
				echo "<input type='submit' value='Agregar nuevo' name='agregar' class='button'></form>";
				echo "<br/>";
				echo "<br/>";
...
function CARGOSUB($numero){
	...
	while($subcontrato=mysql_fetch_array($result))
	{
		if(strlen($subcontrato['Numero'])>8)
		{
			...
			while($Abonosubcontrato=mysql_fetch_array($Bono))
			{
				$cargoss += $Abonosubcontrato['cantidad'];			
			}
		}
	}
	return $cargoss;
...
function vcontacto($num){
	//echo "select count(*) as t from logistica_fechas where contrato='".$num."'";
	$val_flog=mysql_fetch_array(mysql_query("select count(*) as t from logistica_fechas where contrato='".$num."'"));
	if($val_flog["t"]==1){
		///////actualizamos ultima modificacion 
		mysql_query("update logistica_fechas set ultima_modificacion='".date("Y-m-d")."' where contrato='".$num."'");
	}else if($val_flog["t"]==0){
		///insertamos la fecha del primer contacto
		mysql_query("insert into logistica_fechas(contrato,primer_contacto,ultima_modificacion)values('".$num."','".date('Y-m-d')."','".date('Y-m-d')."')");
	}
}
