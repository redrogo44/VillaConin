...
<br /><br /><br  style="background-position:center"/ >
   ...
   <h1>Registrar vinos</h1>
   <br />
    <table border="9" align="center"  bordercolor="#990000" bordercolordark="#990000"	 bordercolorlight="#990000" >
       <tr>
       <form action="alta_vino.php" method="post" name="newregist">
          <td><b>Producto</b></td>
          <td><input name="produ" type="text" size="35" maxlength="35" placeholder="		Nombre del producto ">
       </tr>
       <tr>
      ...
      <tr>
         <td><b>Cantidad</b></td>
         <td><input name="cant" type="text" size="35" maxlength="35" placeholder="		Cantidad de producto">
      </tr>
    <tr>
       <td><b>Precio</b></td>
       <td><input name="prec" type="text" size="35" maxlength="" placeholder="	    	Precio del producto" >
    </tr>
      <tr>
       <td><b>Costo</b></td>
       <td><input name="cost" type="text" size="35" maxlength="" placeholder="		Costo del producto" >
    </tr>
         <td></td>
         <td align="center">
...
function valida_envia(){ 
   	//valido el nombre 
   	if (document.newregist.produ.value.length==0){ 
      	 alert("Tiene que escribir su nombre") 
      	 document.newregist.produ.focus() 
      	 return 0; 
   	}
    }
</script>
