		...
		<div class="wrapper">
			<?php
					if(isset($_POST['submit'])) 
					{
						...
						{
							echo "<script>";
							echo "alert('ERROR.. NO SE PUEDE CANCELAR NADA DE UN EVENTO QUE YA FINALIZO.. VERIFIQUE SU INFORMACION...')";
							echo "</script>";
							echo "<META HTTP-EQUIV='Refresh' CONTENT='0; URL=https://villaconin.mx/index.php'>";
						}
					}
										...
										echo '<tr>													
											...
											{									
												...
												<form action='' method='POST'>
													...
													<input type='submit'  class='BOTON' value='CANCELAR ABONOS'/>
												</form></td>
												</tr>"; 
											}
											echo '</table></div>';
