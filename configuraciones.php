   ...
   echo"</li>
			...
			<li>
				...
				<ul>
					...
					<li><a href='Modificaciones_Generales.php?reinicia=reiniciar' onclick='return confirmarreiniciomeseros()'  Title='Se Reiniciaran todos los atributos de los Meseros'>Reiniciar Meseros </a></li>					
				</ul>
			</li>
...
?>
<script>
function confirmarreiniciomeseros()
{
	if(confirm('¿Esta segur(@) de reiniciar todos los atributos de los Meseros? Tenga en cuenta que no podra recuperar datos importantes como la Cantidad de Eventos o los puntos por cada Mesero'))
		return true;
	else
		return false;
}
