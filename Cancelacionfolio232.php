...
class MiPDF extends FPDF{
	...
	mysql_set_charset('utf8');
	 //echo "conexion exitosa";
		...
		// Tabla Cancelaciones
		$q="select id from Cancelaciones Where id=227";
		$r=mysql_query($q);
		while($muestra=mysql_fetch_array($r)){
			$numax=$muestra['n'];
			
			}
		$q2="select * from Cancelaciones where id=227";
		$r2=mysql_query($q2);
...
$this->Cell(330, -22 , $NumeroContrato, 100, 100, 'C');
 $this->SetXY( 15, 58); // establece las posición actual x e y
$this->MultiCell(170, 8 ,utf8_decode($concepto),'L');
 $this->SetXY( 10, 85); // establece las posición actual x e y
$this->Cell(345, -5 , $total, 100, 100, 'C');
///////////segunda nota de cargo
$this->Ln(41);
$this->Cell(169, 4 ,"",0,'C');
$this->Cell(18, 4 ,$folio,'C');
$this->Ln(5);
$this->Cell(169, 4 ,"",0,'C');
$this->Cell(18, 4 ,$fecha,'C');
$this->Ln(12);
$this->Cell(20, 4 ,"",0,'C');
$this->Cell(133, 4 ,$cliente,0,'C');
$this->Cell(30, 4 ,$NumeroContrato,0,'C');
$this->Ln(14);
$this->Cell(5, 8 ,"",0,'C');
$this->MultiCell(170, 8 ,utf8_decode($concepto),'L');
$this->Ln(6);      
$this->Cell(160, 8 ,"",0,'C');
$this->Cell(30, 8 ,$total,0,'C');
/////tercer nota de cargo
$this->Ln(42);
$this->Cell(169, 4 ,"",0,'C');
$this->Cell(18, 4 ,$folio,'C');
$this->Ln(5);
