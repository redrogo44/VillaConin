...
function refactorCargos () {
  global $conexion;
  // $contrato = [];
  $truncate = "truncate table cargos_new";
  $conexion->query($truncate);
  $alter = "ALTER TABLE `cargos_new` AUTO_INCREMENT = 1;";
  $conexion->query($alter);
  $sql = "INSERT INTO cargos_new (id_cargos, total_adultos, total_jovenes, total_ninos, precio_adultos, precio_jovenes, precio_ninos, total, tipo, fecha, concepto, contrato, tipo_evento) VALUES ";
