				...
				if(isset($_GET['folio']) && !empty($_GET['folio'])){
					...
					if($_GET['tabla']=="comprafac"){
						...
						/////detalle
							...
							echo "<tr><td colspan='3' align='right'>Subtotalllll</td><td align='center'>$".$total."</td></tr>";
					...
					$total=0;$imp;
						...
						echo "</table><br><br>";
						echo "<table class='style2'>";
						echo "<tr><td>Cantidad</td><td>Producto</td><td>Costo</td><td>Importe</td></tr>";///////////////descripcion del movimiento
