							...
							<ul>";
								$tabla="SELECT * FROM detalle WHERE ".$ids;
									...
									while ($ca=mysql_fetch_array($c)) 
									{
										...
										$totalFacturado+=$ttipofac;						
									}						
									
							$totalCompras+=$totalFacturado;
						echo"</ul><font color='green'><b> $ ".money_format("%i",$totalFacturado)."</b></font>
						</li>	
					<li><strong> B </strong>
						<ul>";
								$tabla="SELECT * FROM detalle WHERE ".$ids;
...
/////////////////	FUNCIONES PHP 	///////////////////////7
	...
	{
		    $inv=mysql_query("select * from inventario where id_producto=".$id);
			...
			$total_p=$inv_actual*$inv2['precio'];
