...
conectar();
$result=mysql_query("select * from contrato where Numero='X040715L-13'");
...
$msj=$msj."</tr>";
	...
	//mail($_POST['correo'], 'IMPORTANTE PAGOS', utf8_decode($msj), "From: administracion@sistemavc.com \r\nContent-type: text/html\r\n");
