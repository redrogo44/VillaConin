   ...
   echo"</li>
	...
	echo" <li><a>Usuarios</a>
			<ul>
				...
				<li><a href='Modifica_pass.php' onclick='window.open(this.href, this.target, 'width=300,height=400'); return false;'>Contraseña Cargos</a>
			</ul>
	</li>";
	}
	...
	echo" <li><a href='https://greatmeeting.me/Config/compras.php'>Compras</a></li>";
		echo" <li><a>Usuarios</a>
			<ul>
				...
				<li><a href='https://greatmeeting.me/Config/Modifica_pass.php' onclick='window.open(this.href, this.target, 'width=300,height=400'); return false;'>Contraseña Cargos</a>
			</ul>
	</li>";
