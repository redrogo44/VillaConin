...
$c='update clausulas set descripcion="'.$_POST['contenido'].'" where id='.$_POST['id'];
$r=mysql_query($c);
header('Location: Clausulas.php');
}
elseif($_POST['op']=='Borrar'){
$r=mysql_query('update clausulas set descripcion="" where id='.$_POST['id']);
header('Location: Clausulas.php');
}
else if($_POST['op']=="Insertar"){
$r=mysql_query('insert into clausulas(descripcion) values("'.$_POST['contenido'].'")');
header('Location: Clausulas.php');
}
else{
?>
...
<br><br><br><center>
<form action="MClausulas.php" method="POST">
