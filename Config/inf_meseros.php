...
if($nivel==0||$nivel==1)
	echo "
	<a class= 'ovalbutton' href='Modificaciones_Generales.php?id=".$_POST['q']."' onclick='ALERT(123);'><span>ELIMINAR</span></a>	
    ...
    <a class= 'ovalbutton' href='Historial_Mesero.php?numero=".$_POST['q']."' target='_black'><span>Imprime Historial</span></a>
    ";
if ($nivel==2||$nivel==5) 
{
	echo "
...
<div align='center'>
	...
	<br>
		...
		{
		echo "<label><b>Puntos: </b></label>&nbsp&nbsp&nbsp<font color='#000099'><b>".$puntos."</b></font><br>
