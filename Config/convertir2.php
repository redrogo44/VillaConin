	   ...
	   <br><br>
		<div class="wrapper">
			<?php
					...
					$total2=$total1*1.16;
					//////////////////modificamos el ultimo abono
						///obtenemos los montos
							$monto=explode('%',$md['monto']);
							$index=count($monto);
							$iva=$total1*0.16;;
							$monto[$index-2]= $monto[$index-2]+$iva;
							$montos='';
							...
							$actu_mon=mysql_query("update contrato set monto='".$montos."' where Numero='".$_GET['numero']."'");
