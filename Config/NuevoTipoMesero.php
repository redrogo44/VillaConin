...
<br /><br /><br  style="background-position:center"/ >
   ...
   <br>
   <h5 style="color:#009"><b>Espesificar el Nombre de la Nueva Categoria Sin Espacios (Sustituirlos con '-' o '_' )</b></h5>
  ...
  <form action="alta_mesero.php" method="post" name="newregist">
    <table border="9" align="center"  bordercolor="#990000" bordercolordark="#990000"	 bordercolorlight="#990000" >
      <th></th>
      <tr>
      	<td><b style="color:#F00">Nueva Categiria de Mesero</b></td><td><input  type="text" name="categoria" placeholder=" NOMBRE_DE_NUEVA_CATEGORIA"  required="required"size="35"/></td>
      </tr>
      <td colspan="2" bgcolor="#000000" align="center"><font color="#FFF700"><b>DATOS DEL MESERO</b></font></td>
      <tr></tr>
      <tr>
       <td><b>Nombre</b></td>
    ...
    <tr>
        ...
        <td align="center"><input  align="top" type="date" name="fechaingreso" required/> </td>
    </tr>      
    <tr>	
       <td><b>ESTATUS</b></td>
			<td align="center">
