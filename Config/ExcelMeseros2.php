...
$ORDEN=OrdenaMeseros();
	...
	echo "<tr><td colspan='".(count($Contratos)+2)."' align='center' bgcolor='#F9E2AB'><b bgcolor='#F9E2AB' style='color:#042843' >MESEROS PROYECTADOS</b></td></tr>";
	...
	while ($MESTIPO=mysql_fetch_array($MTIPO3)) 
	{
		...
		while($me=mysql_fetch_array($r))
		{
				if($me['tipo'] == $MESTIPO['tipo'])
				{
					...
					echo "<td bgcolor='#98EAFF'><b>".$me['ap']." ".$me['am']." ".$me['nombre']."</b></td>";
					echo "<td bgcolor='#98EAFF'>".$me['comentarios']."</td>";
...
<body>
<table BORDER ='1'>
<tr><td  align="center"colspan="<?php echo (count($Contratos)+2);?>">PROYECCION DE MESEROS <?php echo $numeroSemana;?></td></tr>
...
<tr bgcolor="#D1FF00"><td border='0' align="center" colspan="<?php echo (count($Contratos)+2);?>"><h6><b>PLANTILLA MESEROS</b></h6></td></tr>
