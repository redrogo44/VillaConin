...
//print_r($_POST);
$MEseros=mysql_query("SELECT * FROM Configuraciones where tipo='Nomina'");
...
<!--ESTILO CUERPO-->
<div align="center">
	<h1><b>NOMINA ACUMULADA</b></h1>
	<font color="blue"><h4><b>Acumulado de Nomina por Categoria</b></h4></font>
	<br><br>
	<table border="6"  >
		<tr><td align="center" bgcolor="#0080C6"><b>Total de Categorias</b></td><td align="center" bgcolor="#9CFC1D"><b><?php echo $cuenta;?></b></td></tr>
			...
			$Acumulado_Puntos=0;
				...
				while ($CATEGORIA=mysql_fetch_array($CAT)) 
				{
					...
					echo"<tr><td align='center' bgcolor='#C9E5FD'><b>".$CATEGORIA['descripcion']."</b></td><td align='center' bgcolor='#FFF014'><b>".'$'.money_format('%.2n', $CATEGORIA['acumulado'])."</b></td></tr>";
				}

			?>
			<td align="center" bgcolor="#000000"><font color="#6FFF00"><h3><b>NOMINA ACUMULADA</b></h3></font></td><td align="center" bgcolor="#000000" ><font color="yellow"><h3><b><?php echo '$ '.money_format('%.2n', $Acumulado_Puntos);?></b></h3></font></td>		

		</tr>
	</table>
	<br>
	<br>
			<a href="Acumulado_Categoria.php" class="boton" target="_black">Imprimir</a>	
