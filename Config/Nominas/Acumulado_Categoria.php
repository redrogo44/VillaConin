...
class MiPDF extends FPDF
{
		...
		public function Header()
		{
				$this->Image('../../Imagenes/Villa Conin.png' , 160 ,12, 45 , 48,'PNG', '');
						...
						// Cliente
						$this->Cell(0, 10 ,"NOMINA ACUMULADA POR CATEGORIA", 2, 2, 'C');					
...
$this->SetDrawColor(116,0,0);
	...
	$this->SetX(50);
					...
					$this->Cell(70,10,$CATEGORIA['descripcion'], 1, 0, 'C');
					$this->Cell(30,10,'$ '.money_format('%.2n', $CATEGORIA['acumulado']), 1, 0, 'C');
					$this->Ln(10);
				}
	$this->SetX(50);
						$this->Cell(70,10,'ACUMULADO TOTAL',1,0,'C');
						$this->Cell(30,10,'$ '.money_format('%.2n',$Acumulado_Puntos),1,0,'C');
